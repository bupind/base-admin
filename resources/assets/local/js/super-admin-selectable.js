        ...
        */
        ...
        init : function(config){
            ...
            var load = function (url) {
                backend.ajax.request(url, {}, function (data) {
            ...
            modal_elm.addEventListener('show.bs.modal', function (event) {
                ...
                backend.ajax.currenTarget = modal_elm.querySelector('.modal-body');
            ...
            modal_elm.addEventListener('hide.bs.modal', function (event) {
                backend.ajax.currenTarget = false;
            })
            ...
            modal_elm.addEventListener('click', function (event) {
                ...
                /*
                // now handeled through backend.ajax.currentTarget
