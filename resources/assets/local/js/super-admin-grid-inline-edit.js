    ...
    backend.grid.inline_edit = {
        ...
        init : function(){
            ...
            document.addEventListener('click', function (event) {
                if (backend.grid.inline_edit.popover){
                    backend.grid.inline_edit.popover.hide();
                }
            });
        },
        ...
        hide_ohter_popovers : function(me){
            ...
            backend.grid.inline_edit.popovers.forEach(popover =>{
        ...
        init_popover : function(triggerId,target){
            ...
            var popover = new bootstrap.Popover(el, {
                ...
                content : function () {
                    ...
                    if(typeof(backend.grid.inline_edit.functions[triggerId]) != 'undefined'){
                        if(typeof(backend.grid.inline_edit.functions[triggerId].content) === "function"){
                            backend.grid.inline_edit.functions[triggerId].content(el,content.content);
                        }
                    }
            ...
            el.addEventListener('show.bs.popover', function (event) {
                ...
                backend.grid.inline_edit.trigger = this;
                backend.grid.inline_edit.popover = popover;
                backend.grid.inline_edit.hide_ohter_popovers(popover)
            ...
            el.addEventListener('shown.bs.popover', function (event) {
                ...
                triggerId = this.id;
                if(typeof(backend.grid.inline_edit.functions[triggerId]) != 'undefined'){
                    if(typeof(backend.grid.inline_edit.functions[triggerId].shown) === "function"){
                        backend.grid.inline_edit.functions[triggerId].shown(el,popover.tip);
                    }
                }
            })
            ...
            backend.grid.inline_edit.popovers.push(popover);

        },

        save : function(){

            let popover = backend.grid.inline_edit.popover;
            let content = popover.tip.querySelector(".ie-container");
        ...
        retrieveValues : function(trigger,content){
            ...
            if(typeof(backend.grid.inline_edit.functions[triggerId]) != 'undefined'){
                if(typeof(backend.grid.inline_edit.functions[triggerId].returnValue) === "function"){
                    val = backend.grid.inline_edit.functions[triggerId].returnValue(trigger,content);
                }
            }
            console.log(val);
            if (!val){
