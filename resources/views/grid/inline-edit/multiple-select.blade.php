@extends('backend::grid.inline-edit.comm')
...
@section('assert')
    <script>
        @component('backend::grid.inline-edit.partials.popover', compact('trigger'))
            @slot('content')
    ...
    <script>
    @component('backend::grid.inline-edit.partials.submit', compact('resource', 'name'))
