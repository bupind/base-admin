        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" style="border-radius: 5px;">
                <div class="modal-header">
                    <h4 class="modal-title">{{ admin_trans('backend.choose') }}</h4>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ admin_trans('backend.cancel') }}</button>
                    <button type="button" class="btn btn-primary submit">{{ admin_trans('backend.submit') }}</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    var update = function (callback) {
        ...
        @if($relation == \Base\Admin\Grid\Displayers\BelongsTo::class)
        ...
        backend.ajax.post(url,data,callback);
    };
    ...
    var resultFunction = function(data){
        ...
        backend.toastr.success(data.data);
    ...
    backend.selectable.init(config);
