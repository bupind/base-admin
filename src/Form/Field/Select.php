...
use Base\Admin\Form\Field\Traits\CanCascadeFields;
    ...
    public function load($field, $url, $idField = 'id', $textField = 'text', bool $allowClear = true)
    {
        ...
        $this->additional_script .= <<<JS
            ...
            elm.addEventListener('change', function(event) {
                ...
                backend.ajax.post("{$url}",{query:query},function(data){
                    let found = false;
                    for (i in data.data){
...
JS;
    ...
    protected function loadRemoteOptions($url, $parameters = [], $options = [])
    {
        ...
        $this->additional_script .= <<<JS
        backend.ajax.post("{$url}",{$parameters_json},function(data){
...
JS;
    ...
    public function allowedChoicesJs()
    {
        ...
        return in_array($class, [
            'Base\Admin\Form\Field\Select',
            'Base\Admin\Form\Field\Tags',
            'Base\Admin\Form\Field\MultipleSelect',
            'Base\Admin\Form\Field\Timezone',
        ]);
    }
