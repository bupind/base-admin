...
use Base\Admin\Grid\Selectable;
...
trait BelongsToRelation
{
    ...
    protected function setSelectable($selectable)
    {
        if (! class_exists($selectable) || ! is_subclass_of($selectable, Selectable::class)) {
            throw new \InvalidArgumentException(
                "[Class [{$selectable}] must be a sub class of Base\Admin\Grid\Selectable"
            );
        }
    ...
    protected function getLoadUrl()
    {
        ...
        return route('backend.handle-selectable', compact('selectable', 'args'));
    }
