...
use Base\Admin\Form\Field\Traits\HasMediaPicker;
use Base\Admin\Form\Field\Traits\UploadField;
...
class File extends Field
{
    ...
    {
        return config('backend.upload.directory.file');
    }
    ...
    public function render()
    {
        ...
        $this->options(['overwriteInitial' => true, 'msgPlaceholder' => trans('backend.choose_file')]);
