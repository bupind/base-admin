...
use Base\Admin\Form\Field\Traits\Sortable;
use Base\Admin\Form\NestedForm;
use Base\Admin\Widgets\Form as WidgetForm;
...
class HasMany extends Field
{
     ...
     */
    protected $views = [
        'default' => 'backend::form.hasmany',
        'tab' => 'backend::form.hasmanytab',
        'table' => 'backend::form.hasmanytable',
    ];
