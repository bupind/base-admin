...
trait HasAssets
{
    ...
    public static $baseJs = [
        ...
        'vendor/base/local/js/base-backend.js',
        'vendor/base/local/js/base-admin-actions.js',
        'vendor/base/local/js/base-admin-grid.js',
        'vendor/base/local/js/base-admin-grid-inline-edit.js',
        'vendor/base/local/js/base-admin-form.js',
        'vendor/base/local/js/base-admin-toastr.js',
        'vendor/base/local/js/base-admin-resource.js',
        'vendor/base/local/js/base-admin-tree.js',
        'vendor/base/local/js/base-admin-selectable.js',
    ];
    /**
     * @var array
     */
