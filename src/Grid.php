...
use Base\Admin\Grid\Concerns;
use Base\Admin\Grid\Displayers;
use Base\Admin\Grid\Model;
use Base\Admin\Grid\Row;
use Base\Admin\Grid\Tools;
...
class Grid
{
     ...
     *
     * @var \Base\Admin\Grid\Model|\Illuminate\Database\Eloquent\Builder
     */
    protected $model;
    /**
     ...
     * @var string
     */
    protected $view = 'backend::grid.table';
    /**
     * @var []callable
     */
    ...
    protected function prependRowSelectorColumn()
    {
        ...
        $checkAllBox = '<input type="checkbox" class="' . $this->getSelectAllName() . ' form-check-input" onchange="backend.grid.select_all(event,this)" id="grid-select-all" />&nbsp;';
