...
use Base\Admin\Form as BaseForm;
...
JS;
    ...
    protected function addCascadeScript()
    {
        ...
        $script = <<<SCRIPT
        backend.form.disable_cascaded_forms("form#{$id}");
SCRIPT;
    ...
    public function render()
    {
        ...
        $form = view('backend::widgets.form', $this->getVariables())->render();
