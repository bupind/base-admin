...
use Base\Admin\Grid\Filter;
use Base\Admin\Grid\Filter\Presenter\Checkbox;
use Base\Admin\Grid\Filter\Presenter\DateTime;
use Base\Admin\Grid\Filter\Presenter\MultipleSelect;
use Base\Admin\Grid\Filter\Presenter\Presenter;
use Base\Admin\Grid\Filter\Presenter\Radio;
use Base\Admin\Grid\Filter\Presenter\Select;
use Base\Admin\Grid\Filter\Presenter\Text;
...
abstract class AbstractFilter
{
     ...
     * @var string
     */
    protected $view = 'backend::filter.where';
