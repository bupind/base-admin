...
namespace Base\Admin\Grid\Displayers\Actions;

use Base\Admin\Actions\RowAction;
use Base\Admin\Admin;
use Base\Admin\Grid\Actions\Delete;
use Base\Admin\Grid\Actions\Edit;
use Base\Admin\Grid\Actions\Show;
use Base\Admin\Grid\Displayers\AbstractDisplayer;

class Actions extends AbstractDisplayer
{
    protected $view = 'backend::grid.actions.actions';
