...
use Base\Admin\Auth\Database\Permission;
...
class PermissionCommand extends Command
{
    ...
    {
        return [
            config('backend.database.users_table'),
            config('backend.database.roles_table'),
            config('backend.database.permissions_table'),
            config('backend.database.menu_table'),
            config('backend.database.operation_log_table'),
            config('backend.database.user_permissions_table'),
            config('backend.database.role_users_table'),
            config('backend.database.role_permissions_table'),
            config('backend.database.role_menu_table'),
        ];
    }
    ...
    {
        return [
            'list' => __('backend.list'),
            'view' => __('backend.view'),
            'create' => __('backend.create'),
            'edit' => __('backend.edit'),
            'delete' => __('backend.delete'),
            'export' => __('backend.export'),
            'filter' => __('backend.filter'),
        ];
    }
