 ...
 * Class Admin.
 *
 * @method static \Base\Admin\Grid grid($model, \Closure $callable)
 * @method static \Base\Admin\Form form($model, \Closure $callable)
 * @method static \Base\Admin\Show show($model, $callable = null)
 * @method static \Base\Admin\Tree tree($model, \Closure $callable = null)
 * @method static \Base\Admin\Layout\Content content(\Closure $callable = null)
 ...
 *
 * @see \Base\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \Base\Admin\Admin::class;
    }
}
