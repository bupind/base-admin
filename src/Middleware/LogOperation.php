...
use Base\Admin\Auth\Database\OperationLog as OperationLogModel;
...
class LogOperation
{
    ...
    {
        $filter = config('backend.operation_log.filter_input', []);
    ...
    {
        $allowedMethods = collect(config('backend.operation_log.allowed_methods'))->filter();
